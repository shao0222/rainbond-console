...
from console.models.plugin import TenantPlugin, PluginBuildVersion, PluginConfigGroup, PluginConfigItems, \
    TenantServicePluginRelation, TenantServicePluginAttr, ConstKey, HasNoDownStreamService, TenantPluginShareInfo
from console.models.services import TenantServiceRelation, TenantServiceInfo, TenantServicesPort
